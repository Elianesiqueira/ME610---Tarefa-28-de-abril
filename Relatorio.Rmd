...
$Fuma_i$: é uma variável binária relacionada ao nível "Fuma" da variável "Fuma".  
$Mex$: é uma variável binária relacionada ao nível "Mex" da variável "Cor do Pai".  
$Mixed$: é uma variável binária relacionada ao nível "Mixed" da variável "Cor do Pai".  
$White$: é uma variável binária relacionada ao nível "White" da variável "Cor do Pai".  
...
$\bar{R}^2$ = 
### 6. Discussão
Observamos que o modelo dito irredutível teve um poder preditivo rezoávelmente bom, portanto faz sentido obter conclusões com base neste modelo. 
