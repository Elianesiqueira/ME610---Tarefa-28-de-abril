...
Analogamente, de acordo com o modelo ajustado, levando-se em consideração as mesmas características inseridas, o fato da mãe fumar tem efeito no peso esperado do bebê equivalente (isoladamente e nas mesmas condições) a:
Efeito de uma redução de 51,87 kg no peso da mãe.
Efeito de uma redução de 9,02 Gestações anteriores da mãe.
Efeito de uma redução de 22,05 cm na altura da mãe.


Como em geral estas variáveis são intrínsecas à mãe, ou seja, não estão sujeitas a alterações estipuladas, temos portanto, que os dados indicam uma concordância com o relato no Surgeon General's Report 1989, ou seja, o fato da mãe fumar parece ser uma variável mais determinante quanto ao peso do bebê do que altura, o peso, o número de fetos, a renda anual da mãe, o histórico de resultados de gestações anteriores ou o sexo do bebê.
