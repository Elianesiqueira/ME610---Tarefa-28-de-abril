...
\begin{block}{Verificar a válidade desta opinião:}
...
Explicar a metodologia passo a passo em detalhes (pensar em topicos para deixar no slide);  \pause 
